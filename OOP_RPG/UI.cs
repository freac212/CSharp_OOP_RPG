...
namespace OOP_RPG
{
    static class UI
    {
        ...
        public static void DisplayItemList(List<IGameItem> list)
        {
            if (list.Any())
            {
        ...
        public class Grid
        {
            ...
            public static Grid GridLeft()
            {
                // Grid space one.. Usually Inventory.
                return new Grid(0, Console.BufferWidth / 3);
            }

            public static Grid GridCenter()
            {
                return new Grid(Console.BufferWidth - ((Console.BufferWidth / 3) * 2), Console.BufferWidth - (Console.BufferWidth / 3));
            }

            public static Grid GridRight()
            {
                return new Grid(Console.BufferWidth - (Console.BufferWidth / 3), Console.BufferWidth);
            }
        }
        ...
        public class Draw
        {
            ...
            //private int InnerBoxWidth = OneThirdOfConsole - 1;
